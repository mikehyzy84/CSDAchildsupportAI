      ...
      <div className="flex-1 overflow-hidden flex flex-col max-w-5xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {EXAMPLE_QUESTIONS.map((q, i) => (
                    <button
                      ...
                      className="text-left p-4 bg-white border rounded-lg hover:border-amber-400 disabled:opacity-50"
                    >
                      {q}
                    </button>
                  ))}
        ...
        <div className="border-t bg-white p-4">
          <form onSubmit={handleTextSubmit} className="flex items-center gap-2">
            <div className="flex-1 flex gap-2 border rounded-lg px-4 py-3">
              <input
                type="text"
                value={textInput}
